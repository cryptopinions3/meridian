...
function upgradeUpdate1(){
  document.getElementById('upgradeAmount2').value=document.getElementById('upgradeAmount').value
}
function upgradeUpdate2(){
  document.getElementById('upgradeAmount').value=document.getElementById('upgradeAmount2').value
}
